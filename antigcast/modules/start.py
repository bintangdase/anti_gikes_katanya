...
inlinegc = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="Owner", url="https://t.me/suckmydicks"), #isi link telegram 
            InlineKeyboardButton(text="Channel", url="https://t.me/inylord") #isi link channel store
        ]
    ]
)
